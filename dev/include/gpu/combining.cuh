...
template <
    ...
    requires ConvertibleToAll<X, Out1, Out2> and
             ConvertibleToAll<Y, Out1, Out2>
__global__ void
crossover(
    device_ptr_in<X>     xs,
    const std::size_t    n,
...
concept Crossoverable =
    IterValConvertibleToIterVal<IterX, IterOut1, IterOut2> and IterValConvertibleTo<IterY, IterOut1, IterOut2>;
